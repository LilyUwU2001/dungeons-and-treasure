            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_choice == 'healing_potion':
                    ...
                    item_component = Item(use_function=cast_fireball, targeting=True, targeting_message=Message(
                        'Left-click a target tile for the spell or right-click to cancel.', libtcod.light_cyan),
                                          damage=25, radius=3)
                    ...
                    item = Entity(x, y, '#', libtcod.orange, 'Teleport Scroll', render_order=RenderOrder.ITEM,
                                  item=item_component)
